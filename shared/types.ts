...
export interface Transaction extends BaseEntity {
  ...
  supplierId?: string; // Supplier ID if related to supplier
  productionOrderId?: string; // Production Order ID if related to production
...
export interface Supplier extends BaseEntity {
  ...
  taxId?: string;
  paymentTerms: string;
  categories: string[]; // Types of materials/products they supply
